...
const AuthBtn = ({ variant = 'yellow', children, ...rest }: AuthBtnProp) => {
  const base =
    'min-w-[130px] bg-[var(--bg-btn)] text-[var(--text-btn)]  border p-[8px] mr-2 rounded-tl-3xl rounded-br-3xl cursor-pointer transition-all duration-300 focus:outline-none ';
